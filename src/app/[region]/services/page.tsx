      ...
      <section className="py-20 bg-white border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-3xl sm:text-4xl font-heading font-bold text-slate-900">
              Enterprise-Grade AI Security & Stack.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md transition-shadow">
              <div className="p-3 rounded-2xl bg-blue-50 text-blue-600 w-fit mb-6">
                <Network className="w-6 h-6" />
              </div>
              <h3 className="font-heading font-bold text-xl text-slate-900 mb-3">Multi-Agent Swarm Logic</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
                Specialized micro-agents (lead qualifier, inventory checker, calendar scheduler, CRM sync) communicating via high-speed IPC pipelines.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Private vector databases indexed with your company docs, product catalogs, pricing sheets, and policy manuals with zero hallucination safeguards.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Automated escalation to human staff when confidence thresholds drop, paired with complete audit trails and data encryption.
              </p>
            </div>
          </div>
        </div>
