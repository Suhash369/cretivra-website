...
import { TrendingUp, Clock, CheckCircle, Quote, Star } from "lucide-react";
  ...
  const cases = [
    {
      ...
      quote:
        "Cretivra built a WhatsApp sales qualification agent that greets inbound leads instantly, collects buyer criteria, and schedules site visits directly into our CRM. Our lead drop-off dropped to zero.",
    ...
    },
    {
      ...
      quote:
        "Our customer support was drowning in repetitive order tracking and return queries. Cretivra's multi-agent solution handles 85% of enquiries end-to-end with flawless customer satisfaction scores.",
    ...
    },
    {
      ...
      quote:
        "The custom multi-agent system Cretivra delivered ingests complex vendor quote specs and calculates pricing automatically. It changed how we scale across European and APAC markets.",
      author: "David Chen",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-3xl sm:text-5xl font-heading font-extrabold text-slate-900">
            Measurable ROI Across Global Markets.
          </p>
          <p className="mt-4 text-slate-600 text-base sm:text-lg">
            Real performance benchmarks achieved by businesses powered by Cretivra AI agent infrastructure.
          </p>
        </div>
