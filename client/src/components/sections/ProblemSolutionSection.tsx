...
export default function ProblemSolutionSection() {
  ...
  const oldWayItems = [
    { title: "Manual Enquiry Triage", desc: "Sales reps spending hours copying lead data from WhatsApp & forms into spreadsheets." },
    { title: "12+ Hour Response Delays", desc: "High-intent buyers move to competitors before your team even reads their initial message." },
    { title: "Missed Weekend & Night Leads", desc: "Zero response coverage outside 9-to-5 office hours causes up to 40% lead drop-off." },
    { title: "Fragmented Data & Human Error", desc: "Inconsistent follow-ups, untracked conversation status, and zero unified analytics." },
  ];

  const cretivraWayItems = [
    { title: "Instant Autonomous AI Triage", desc: "AI agents engage enquiries instantly on WhatsApp, Web, or Email within 3 seconds." },
    { title: "24/7 Real-Time Lead Qualification", desc: "Intelligent agents ask qualifying questions, collect criteria, and book calendar meetings automatically." },
    { title: "Zero Lead Drop-Off Guaranteed", desc: "Round-the-clock SLA execution ensuring every inbound prospect receives human-like assistance anytime." },
    { title: "Direct ERP/CRM Sync & Intelligence", desc: "Structured data pushed directly to Salesforce, HubSpot, or custom databases with audit logs." },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          <div className={`p-8 rounded-3xl transition-all duration-300 border ${
            activeTab === "problem"
              ? "bg-red-50/50 border-red-200 shadow-xl ring-1 ring-red-200"
          ...
          <div className={`p-8 rounded-3xl transition-all duration-300 border ${
            activeTab === "solution"
              ? "bg-white border-blue-300 shadow-xl ring-2 ring-blue-500/20"
              : "bg-slate-50/50 border-slate-200 opacity-70"
          }`}>
